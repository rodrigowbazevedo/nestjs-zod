...
import { ZodIssueBase, ZodIssueCode, ZodIssueOptionalMessage, ParseContext, ZodErrorMap, ZodTypeDef, ZodSchema, z, ZodType, ParseInput, ParseReturnType } from 'zod/v3';
export * from 'zod/v3';
...
declare class ZodDateString extends ZodType<string, ZodDateStringDef> {
    ...
    cast(): zod_v3.ZodEffects<this, Date, zod_v3.input<this>>;
    get format_(): ({
        kind: "format";
    } & {
        kind: "format";
